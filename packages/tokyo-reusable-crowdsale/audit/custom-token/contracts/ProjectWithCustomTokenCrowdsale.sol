...
contract ProjectWithCustomTokenCrowdsale is BaseCrowdsale, MiniMeBaseCrowdsale, BonusCrowdsale, PurchaseLimitedCrowdsale, MinimumPaymentCrowdsale, BlockIntervalCrowdsale, KYCCrowdsale, StagedCrowdsale, FinishMintingCrowdsale {

  bool public initialized;

  // constructor parameters are left padded bytes32.

  function ProjectWithCustomTokenCrowdsale(bytes32[7] args) 
    BaseCrowdsale(
      parseUint(args[0]))
    MiniMeBaseCrowdsale(
      parseAddress(args[1]))
